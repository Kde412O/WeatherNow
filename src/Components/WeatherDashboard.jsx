    ...
    >
      ...
      <div className="flex flex-col justify-center items-center w-full py-2 gap-4">
        <form
          ...
          className="w-full flex flex-col sm:flex-row gap-2 justify-center items-center"
        >
          <input
            type="search"
            value={location}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col space-y-2 items-center">
                    ...
                    <p>Low: {convertTemperature(item.main.temp_min)}</p>
        ...
        <div className="bg-red-200 border border-red-400 text-red-700 rounded-lg p-4 shadow-md mt-4">
          <div className="flex items-center">
            ...
            >
              <path
                fillRule="evenodd"
                d="M10 18a8 8 0 100-16 8 8 0 000 16zM11 7a1 1 0 00-2 0v5a1 1 0 102 0V7z"
                clipRule="evenodd"
              />
            </svg>
